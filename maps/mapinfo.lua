...
local mapinfo = {
	...
	lighting = {
		...
		sunStartAngle = 0.0,
		sunOrbitTime  = 1440.0,
		sunDir        = {0.5, 1.0, 0.5, 1e9},

		--// unit & ground lighting
		groundAmbientColor  = {0.2, 0.1, 0.3},
		groundDiffuseColor  = {0.65, 0.75, 0.5},
		groundSpecularColor = {0.1, 0.1, 0.1},
		groundShadowDensity = 0.4,
		unitAmbientColor    = {0.4, 0.4, 0.0},
